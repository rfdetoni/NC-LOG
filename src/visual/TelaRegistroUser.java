...
public class TelaRegistroUser {
	/**
	 * Não alterar nada aqui até a linha 49
	 */
	...
	private void initialize() {
		...
		txtRegistroUser = new JTextField();			// Espaço para o user digitar o usuario (getText)
		txtRegistroUser.setBounds(174, 105, 86, 20);
		frmNcLog.getContentPane().add(txtRegistroUser);
		txtRegistroUser.setColumns(10);
		
		txtRegistoPassword = new JPasswordField(); // Espaço para o user digitar a senha (getText)
