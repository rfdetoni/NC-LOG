...
public class CreatePlanodeAcao extends javax.swing.JFrame {
	...
	private void initComponents() {
				...
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
										.addComponent(txtNomeNC, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 168,
												Short.MAX_VALUE)
										.addComponent(txtresp, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 168,
												Short.MAX_VALUE)
										.addComponent(txtLocal, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 168,
												Short.MAX_VALUE))
								.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
										.addGroup(jPanel1Layout.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(lblresponsavel_Nc, GroupLayout.PREFERRED_SIZE, 47,
										...
										.addGroup(Alignment.TRAILING,
												jPanel1Layout.createParallelGroup(Alignment.LEADING)
														.addGroup(jPanel1Layout.createSequentialGroup().addGap(6)
																.addComponent(lblLocal, GroupLayout.PREFERRED_SIZE, 126,
																		GroupLayout.PREFERRED_SIZE))
														.addComponent(lblnome_Nc, GroupLayout.PREFERRED_SIZE, 149,
																GroupLayout.PREFERRED_SIZE)))))
				.addGap(59)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout
				...
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel5).addComponent(
						txtidnc, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel6)
						.addComponent(jLabel7).addComponent(lblresponsavel_Nc).addComponent(txtresp,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel8)
						.addComponent(lblnome_Nc).addComponent(txtNomeNC, GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel9)
						.addComponent(lblLocal).addComponent(txtLocal, GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.TRAILING).addGroup(layout.createSequentialGroup()
				...
				.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						.addGroup(layout.createSequentialGroup()
								.addComponent(btnCancelar, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE).addGap(146)
								.addComponent(btnSalvar, GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE).addGap(137))
						.addGroup(layout.createSequentialGroup().addGap(99)
								.addComponent(jLabel4, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE).addGap(245))))
				.addGroup(Alignment.LEADING, layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(Alignment.TRAILING).addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(txtnome_criador, 178, 178, 178).addComponent(jLabel3)
								...
								.addComponent(txtestrategia, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 775,
										GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(Alignment.LEADING,
								layout.createSequentialGroup()
										.addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addGap(68).addComponent(jLabel4))
						.addGroup(Alignment.LEADING, layout.createSequentialGroup().addComponent(jLabel1)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(txtNome_planodeacao, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(jLabel2)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(txtnome_criador, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(jLabel3).addGap(18)
								.addComponent(txttime_resp, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
				.addGap(23).addComponent(txtestrategia, GroupLayout.PREFERRED_SIZE, 142, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(Alignment.BASELINE)
	...
	private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		String nome_criador, plano, estrategia, time;
		nome_criador = txtnome_criador.getText();
		plano = txtNome_planodeacao.getText();
		estrategia = txtestrategia.getText();
		time = txttime_resp.getText();

		if (plano.equals("")) { // valida preenchimento dos campos
			JOptionPane.showMessageDialog(null, "Campo Titulo do Plano de ação não pode estar vazio", "AVISO",
					JOptionPane.WARNING_MESSAGE);
		} else if (nome_criador.equals("")) {
			JOptionPane.showMessageDialog(null, "Campo Responsável não pode estar vazio", "AVISO",
					JOptionPane.WARNING_MESSAGE);
		} else if (time.equals("")) {
			JOptionPane.showMessageDialog(null, "Campo Time responsável não pode estar vazio", "AVISO",
					JOptionPane.WARNING_MESSAGE);
		} else if (estrategia.equals("")) {
			JOptionPane.showMessageDialog(null, "Campo Estratégia não pode estar vazio", "AVISO",
					JOptionPane.WARNING_MESSAGE);
		} else {
			try {
				plan.setNome_Criador(nome_criador);
				plan.setNome_Plano(plano);
				plan.setEstrategia(estrategia);
				plan.setTime_resp(time);
				...
				JOptionPane.showMessageDialog(null, "Informe ao desenvolvedor CreatePlanodeAcao btnSalvar", "ERRO",
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CreatePlanodeAcao.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
